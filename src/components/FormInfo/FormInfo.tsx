      ...
      <FormInfoContainer>
        ...
        {formType === "signin" && (
          <>
            ...
            <FormInfoText>
              <span>Пароль:</span> Пароль должен быть не меньше 8 символов и состоять только из латинских букв, также должен включать в cебя цифры и специальные символы на выбор ({" . , ! ? > < # $ "}). <br /> Пример - Star54321!
            </FormInfoText>
          </>
        )}
      </FormInfoContainer>
